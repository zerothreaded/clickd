						...
						<div class="row">
							<div class="col-xs-6 col-sm-6 col-md-6">
								<div class="form-group">
									<input type="text" name="firstName" id="first_name" class="form-control input-md valid" placeholder="First Name" tabindex="1" data-validation="length" data-validation-length="min2" style="">
								</div>
							</div>
							<div class="col-xs-6 col-sm-6 col-md-6">
								<div class="form-group">
									<input type="text" name="lastName" id="last_name" class="form-control input-md valid" placeholder="Last Name" tabindex="2" data-validation="length" data-validation-length="min2" style="">
								</div>
							</div>
						</div>
						<div class="form-group">
