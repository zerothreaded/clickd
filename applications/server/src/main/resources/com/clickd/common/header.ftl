			...
			<ul class="nav-notification clearfix">
				...
				<li class="profile dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a tabindex="-1" class="main-link logoutConfirm_open" href="/users/${token?html}/signout" data-popup-ordinal="0" id="open_67128750"><i class="fa fa-lock fa-lg"></i> Log out</a></li>
					</ul>
				</li>
			</ul>
		</div><!-- /top-nav-->
